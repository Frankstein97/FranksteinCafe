...
const handleClickGithub = ()=>{
  window.open('https://github.com/Frankstein97/FranksteinCafe', '_blank')
  }
  const handleClickLinkedin = ()=>{
    window.open('https://www.linkedin.com/in/franco-nicoletti-2993b3a7/', '_blank')
    }
      ...
      <div className="container text-center m-3">
        <div className="footer_row row row_nav">
          ...
          <NavLink to={"/products"}>
            ...
            <p>Usd. esta es una DEMO ilustrativa</p>
          </div>
          <div className="col align-self-center">
            <h4>CAFE APP</h4>
            <NavLink to={"/"}>
          ...
          <div className="redes col align-self-center">
            ...
            <p>Consultas al LinkedIn y codigo en Github :)</p>
