    ...
    <div className='Footer'>
        ...
        <div class="row roww">
            <div class="col align-self-center">
                <p>Realiza tu pedido online o al mail</p>
                <h5 class="p-2">cafeapp@gmail.com</h5>
                <p>Y coordinamos el envio de a cuerdo a tu zona</p>
            ...
            <div class="redes col align-self-center">
                <h5>Podes chusmear las redes:</h5>
                <p>Consultanos al Instagram y al toque te respondemos</p>
