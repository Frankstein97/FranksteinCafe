...
const AboutUs = () => {
  return (
    ...
    <h1>QUIENES SOMOS</h1>
    <p>Somos una corriente Argentina, constituida en un curso de React, con domicilio social en Villa Crespo. Trabajamos para mejorar nuestras habilidades de programacion. Y tambien para  fomentar la apreciacion del cafe. </p>
    <p>MISIÓN: Nuestra misión es generar cultura del gusto por las cosas bien hechas alrededor de una taza de café.</p>
    <p>VISIÓN: Nuestra visión es ser reconocidos en el mundo, por la producción, transformación y comercialización de cafés especiales de Colombia y otros orígenes, con características derivadas de la alta calidad en los procesos de cultivo, transformación y servicio.</p>
